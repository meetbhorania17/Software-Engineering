...
namespace login_form.CitiSoftDBDataSet1TableAdapters {
    ...
    public partial class userLoginTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[userLogin] WHERE (([UserId] = @Original_UserId))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[userLogin] ([Username], [Password]) VALUES (@Username, @Passwo" +
                "rd);\r\nSELECT UserId, Username, Password FROM userLogin WHERE (UserId = SCOPE_IDE" +
                "NTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[userLogin] SET [Username] = @Username, [Password] = @Password WHERE" +
                " (([UserId] = @Original_UserId));\r\nSELECT UserId, Username, Password FROM userLo" +
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT UserId, Username, Password FROM dbo.userLogin";
        ...
        public virtual int Fill(CitiSoftDBDataSet1.userLoginDataTable dataTable) {
        ...
        public virtual CitiSoftDBDataSet1.userLoginDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CitiSoftDBDataSet1.userLoginDataTable dataTable = new CitiSoftDBDataSet1.userLoginDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CitiSoftDBDataSet1.userLoginDataTable dataTable) {
